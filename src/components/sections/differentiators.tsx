...
const differentiators = [
  {
    ...
    description: "Seu tempo é valioso. A limpeza começa e termina no horário combinado, com a agilidade e eficiência que você espera de uma diarista profissional.",
    icon: <Clock className="h-10 w-10 text-primary" />,
  },
  {
    title: "Cuidado nos Detalhes",
    description: "Uma limpeza que vai além do superficial. Cada canto do seu ambiente recebe a atenção necessária para um resultado que você sente e vê.",
    icon: <Sparkles className="h-10 w-10 text-primary" />,
  },
  {
    title: "Diarista de Confiança",
    description: "Sua tranquilidade é a prioridade. Conte com uma profissional dedicada a cuidar do seu espaço com o máximo de respeito, segurança e referências.",
    ...
    <section id="differentiators" className="w-full py-16 md:py-24 bg-secondary">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-muted-foreground font-body text-lg">Mais do que limpeza, ofereço a tranquilidade de ter seu lar bem cuidado.</p>
        </div>
