...
const differentiators = [
  {
    ...
    description: "Respeito seu tempo e seus compromissos. A limpeza começa e termina no horário combinado, com a eficiência que você espera.",
    ...
    <section id="differentiators" className="w-full py-16 md:py-24 bg-card">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl font-bold font-headline text-foreground sm:text-4xl uppercase">MEU COMPROMISSO COM VOCÊ</h2>
          <p className="mt-4 text-muted-foreground font-body text-lg">Mais do que limpeza, ofereço tranquilidade e cuidado.</p>
        </div>
